...
type LabRecordsBatch struct {
	// Pieprasījuma unikāls identifikators GUID formātā. Sūtot sākotnējo pieprasījumu lauks tiek atstāts tukšs (identifikators tiks saņemts Response ietvarā)
	BatchId string `json:"batchId,omitempty"`
	// Pieprasījuma datums un laiks. Tiek sagaidīts laiks UTC zonā
	RequestDate time.Time `json:"requestDate,omitempty"`

	LabRecordsList []LabRecords `json:"labRecordsList,omitempty"`
}
