...
type Address struct {
	...
	AddressCountry int32 `json:"addressCountry"`

	AddressType *AddressType `json:"addressType"`

	AddressRegisterId int32 `json:"addressRegisterId,omitempty"`

	AddressText string `json:"addressText,omitempty"`

	AddressATVK *OneOfAddressAddressAtvk `json:"addressATVK,omitempty"`
}
