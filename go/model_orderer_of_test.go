 ...
 */
package swagger
// OrdererOfTest : Izmeklējuma pasūtītājs no klasifikatora (paredzamās vērtības: Pacients, ārstniecības persona, SPKC, Veselības Inspekcija (VI), cits). Ja pasūtītājs ir SPKC vai VI, tad obligāti ir papildus lauki 
type OrdererOfTest int32

// List of OrdererOfTest
const (
	1_ OrdererOfTest = "1"
	2_ OrdererOfTest = "2"
	3_ OrdererOfTest = "3"
	99_ OrdererOfTest = "99"
)
